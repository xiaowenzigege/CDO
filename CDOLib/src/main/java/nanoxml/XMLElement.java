 ...
 * XMLElement.java
 * 
 * $Revision: 1.4 $ $Date: 2002/03/24 10:27:59 $ $Name: RELEASE_2_2_1 $
 * 
 * This file is part of NanoXML 2 Lite. Copyright (C) 2000-2002 Marc De Scheemaecker, All Rights Reserved.
 * 
 ...
 * {@link #enumerateAttributeNames() enumerateAttributeNames}. The attribute values can be retrieved using the method
 * {@link #getStringAttribute(java.lang.String) getStringAttribute}. The following example shows how to list the
 ...
 * <DD> You can enumerate the children of an element using {@link #enumerateChildren() enumerateChildren}. The number
 * of child elements can be retrieved using {@link #countChildren() countChildren}. </DD>
 * </DL>
 * <DL>
 ...
 * {@link #createAnotherElement() createAnotherElement} which has to return a new copy of the receiver. </DD>
 * </DL>
 * <P>
 * 
...
public class XMLElement
{
	 ...
	 * <ul>
	 * <li>The field is never <code>null</code>.
	 * <li>The field always contains the following associations: "lt"&nbsp;=&gt;&nbsp;"&lt;",
	 * "gt"&nbsp;=&gt;&nbsp;"&gt;", "quot"&nbsp;=&gt;&nbsp;"\"", "apos"&nbsp;=&gt;&nbsp;"'",
	 * "amp"&nbsp;=&gt;&nbsp;"&amp;"
	 ...
	 * </dl>
	 * 
	 * @see nanoxml.XMLElement#XMLElement(java.util.HashMap) XMLElement(HashMap)
	 * @see nanoxml.XMLElement#XMLElement(boolean)
	 * @see nanoxml.XMLElement#XMLElement(java.util.HashMap,boolean) XMLElement(HashMap, boolean)
	 */
	public XMLElement()
	{
	 ...
	 * Creates and initializes a new XML element.
	 * <P>
	 * This constructor should <I>only</I> be called from {@link #createAnotherElement() createAnotherElement} to
	 ...
	 * <ul>
	 * <li><code>entities != null</code>
	 * <li>if <code>fillBasicConversionTable == false</code> then <code>entities</code> contains at least the
	 * following entries: <code>amp</code>, <code>lt</code>, <code>gt</code>, <code>apos</code> and
	 * <code>quot</code>
	 * </ul>
	 * </dd>
	 * </dl>
	 ...
	 */
	protected XMLElement(HashMap entities,boolean skipLeadingWhitespace,boolean fillBasicConversionTable,
					boolean ignoreCase)
	{
		...
		this.lineNr=0;
		Iterator enum1=this.entities.keySet().iterator();
		while(enum1.hasNext())
		{
	 ...
	 * @see nanoxml.XMLElement#getAttribute(java.lang.String, java.util.HashMap, java.lang.String, boolean)
	 ...
	 * @see nanoxml.XMLElement#getStringAttribute(java.lang.String, java.util.HashMap, java.lang.String, boolean)
	 ...
	 * @param value The value of the attribute.
	 * 
	 * @deprecated Use {@link #setAttribute(java.lang.String, java.lang.Object) setAttribute} instead.
	 */
	 ...
	 * @see nanoxml.XMLElement#getIntAttribute(java.lang.String, java.util.HashMap, java.lang.String, boolean)
	 ...
	 * @param value The value of the attribute.
	 * 
	 * @deprecated Use {@link #setIntAttribute(java.lang.String, int) setIntAttribute} instead.
	 */
	 ...
	 * @see nanoxml.XMLElement#getDoubleAttribute(java.lang.String, java.util.HashMap, java.lang.String, boolean)
	 ...
	 * @param value The value of the attribute.
	 * 
	 * @deprecated Use {@link #setDoubleAttribute(java.lang.String, double) setDoubleAttribute} instead.
	 */
	 ...
	 * @see nanoxml.XMLElement#getDoubleAttribute(java.lang.String, java.util.HashMap, java.lang.String, boolean)
	 * getDoubleAttribute(String, HashMap, String, boolean)
	 * @see nanoxml.XMLElement#getBooleanAttribute(java.lang.String, java.lang.String, java.lang.String, boolean)
	...
	/**
	 * Returns the line nr in the source data on which the element is found. This method returns <code>0</code> there
	 * is no associated source data.
	 * 
	 * <dl>
	 * <dt><b>Postconditions:</b></dt>
	 * <dd>
	 ...
	 * "1"</code> and the element contains the
	 * attribute <code>attr="one"</code>, then <code>getAttribute("attr", mapping, defaultKey, false)</code>
	 * returns <code>"1"</code>.
	 * 
	 * @param name The name of the attribute.
	 * @param valueSet HashMap mapping keys to values.
	 ...
	 * <P>
	 * As an example, if valueSet contains the mapping <code>"one" =&gt;
	 * 1.0</code> and the element contains the
	 ...
	 * the value of the attribute is equal to <code>trueValue</code>, <code>true</code> is returned. If the value
	 * of the attribute is equal to <code>falseValue</code>, <code>false</code> is returned. If the value doesn't
	 * match <code>trueValue</code> or <code>falseValue</code>, an exception is thrown.
	 * 
	 * @param name The name of the attribute.
	 ...
	 * Returns an attribute by looking up a key in a hashtable.
	 * 
	 * @deprecated Use {@link #getAttribute(java.lang.String, java.util.HashMap, java.lang.String, boolean)
	 ...
	 * <dd>
	 * <ul>
	 * <li>the state of the receiver is updated to reflect the XML element parsed from the reader
	 * <li>the reader points to the first character following the last '&gt;' character of the XML element
	 * </ul>
	 * </dd>
	 * </dl>
	 * <dl>
	 ...
	 * @throws nanoxml.XMLParseException If an error occured while parsing the read data.
	 */
	 ...
	 * @param name The name of the attribute.
	 * 
	 * @deprecated Use {@link #removeAttribute(java.lang.String) removeAttribute} instead.
	 */
	 ...
	 * <ul>
	 * <li><code>result != null</code>
	 * <li>The next character read from the reader is a valid first character of an XML identifier.
	 * </ul>
	 * </dd>
	 * </dl>
	 * 
	 ...
	 * <dd>
	 * <ul>
	 * <li>The next character read from the reader won't be an identifier character.
	 * </ul>
	 * </dd>
	 * </dl>
	 * <dl>
