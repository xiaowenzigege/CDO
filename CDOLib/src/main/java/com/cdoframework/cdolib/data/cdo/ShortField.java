 ...
 * *** empty log message ***
 *
 * Revision 1.3  2008/03/10 14:54:18  Frank
 * *** empty log message ***
 *
 * Revision 1.2  2008/03/08 12:10:55  Frank
 * *** empty log message ***
 *
...
public class ShortField extends ValueFieldImpl
{
	...
	public void toXML(StringBuilder strbXML)
	{
		...
		strbXML.append(" V=\"").append(this.shValue).append("\"/>");
	}
	...
	{
		return new Short(shValue);
	}

	public ObjectExt getObject()
	{
		return new ObjectExt(this.getType(),shValue);
	}
	...
	public String toJSON()
	{
		...
		str_JSON.append("\"").append(this.getName()).append("\"").append(":").append(this.shValue).append(",");
