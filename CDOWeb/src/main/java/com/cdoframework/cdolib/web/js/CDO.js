...
function BooleanField(strName, bValue) {
	...
	this.toXMLWithIndent= function (nIndentSize) {
		...
		strXML = strIndent + "<BF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.bValue + "\"/>\r\n";
		return strXML;
	};
...
function ByteField(strName, byValue) {
	...
	this.toXMLWithIndent= function (nIndentSize) {
		...
		strXML = strIndent + "<BYF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.byValue + "\"/>\r\n";
		return strXML;
	};
...
function ShortField(strName, shValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<SF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.shValue + "\"/>\r\n";
		return strXML;
	};
...
function IntegerField(strName, nValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<NF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.nValue + "\"/>\r\n";
		return strXML;
	};
...
function LongField(strName, lValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<LF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.lValue + "\"/>\r\n";
		return strXML;
	};
...
function FloatField(strName, fValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<FF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.fValue + "\"/>\r\n";
		return strXML;
	};
...
function DoubleField(strName, dblValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<DBLF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.dblValue + "\"/>\r\n";
		return strXML;
	};
	
	this.toJSONString= function (){
		str_JSON="\\\""+this.getName()+"\\\""+":"+this.fdblalue+",";
		return str_JSON;
	};
...
function StringField(strName, strValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<STRF N=\"" + this.strName + "\"";
		strXML += " V=\"" + encodeToXMLText(this.strValue) + "\"/>\r\n";
		return strXML;
	};
...
function DateField(strName, strValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<DF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.strValue + "\"/>\r\n";
		return strXML;
	};
...
function TimeField(strName, strValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<TF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.strValue + "\"/>\r\n";
		return strXML;
	};
...
function DateTimeField(strName, strValue) {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<DTF N=\"" + this.strName + "\"";
		strXML += " V=\"" + this.strValue + "\"/>\r\n";
		return strXML;
	};
...
function ByteArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<BYAF N=\"" + this.strName + "\"";
		strXML+= " V=\"";
		for (var i = 0; i < this.bysValue.length; i = i + 1) {
			if(i>0)
			{
...
function ShortArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<SAF N=\"" + this.strName + "\"";
		strXML+= " V=\"";
		for (var i = 0; i < this.shsValue.length; i = i + 1) {			
			if(i>0)
			{
...
function IntegerArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML =strIndent+"<NAF N=\"" + this.strName + "\"";
		strXML+= " V=\"";
		for (var i = 0; i < this.nsValue.length; i = i + 1) {
			if(i>0)
			{
...
function LongArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<LAF N=\"" + this.strName + "\"";
		strXML+= " V=\"";
		for (var i = 0; i < this.lsValue.length; i = i + 1) {
			if(i>0)
			{
...
function FloatArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<FAF N=\"" + this.strName + "\"";
		strXML+=" V=\"";
		for (var i = 0; i < this.fsValue.length; i = i + 1) {
			if(i>0)
			{
...
function DoubleArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<DBLAF N=\"" + this.strName + "\"";
		strXML+=" V=\"";
		for (var i = 0; i < this.dblsValue.length; i = i + 1){
			if(i>0)
			{
...
function StringArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<STRAF N=\"" + this.strName + "\">\r\n";
		for (var i = 0; i < this.strsValue.length; i = i + 1) {
...
function DateArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<DAF N=\"" + this.strName + "\"";
		strXML +=" V=\""; 
		for (var i = 0; i < this.strsValue.length; i = i + 1) {
			if(i>0)
			{
...
function TimeArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<TAF N=\"" + this.strName + "\"";
		strXML+=" V=\"";
		for (var i = 0; i < this.strsValue.length; i = i + 1) {
			if(i>0)
			{
...
function DateTimeArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<DTAF N=\"" + this.strName + "\"";
		strXML+=" V=\"";
		for (var i = 0; i < this.strsValue.length; i = i + 1) {
			if(i>0)
			{
...
function CDOField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<CDOF N=\"" + this.strName + "\">\r\n";
...
function CDOArrayField() {
	...
	this.toXMLWithIndent = function (nIndentSize) {
		...
		strXML = strIndent + "<CDOAF N=\"" + this.strName + "\">\r\n";
		for (var i = 0; i < this.cdosValue.length; i = i + 1) {
...
function CDO() {
			 ...
			 case "BF"://StringField
				...
				if (getBrowserType() == "Firefox") {
					...
					for(var ff = 0;ff < firxFoxChildNodes.length;ff = ff+1){
						if(firxFoxChildNodes[ff]){
							if(firxFoxChildNodes[ff].nodeType==1){//节点类型 ：Node.ELEMENT_NODE
					...
					cdoValue.fromXML(node.childNodes[0]);
				}
			  ...
			  case "STRAF"://StringArrayField
				...
				if (getBrowserType() == "Firefox") {
					...
					var firxFoxChildNodes = new Array(items.length);
					var xx=0;
				...
				for (var j = 1; j <= length; j = j + 1) {
					if (getBrowserType() == "Firefox") {
						var _node=firxFoxChildNodes[j - 1];
						if(typeof _node.text == "undefined"){
							arrValue[j - 1]=_node.textContent;
						}else{
							arrValue[j - 1]=_node.text;
						}
					} else {
						arrValue[j - 1] = items[j - 1].text;
					}
				}
				field.setName(strName);
				field.setValue(arrValue);
	...
	this.getStringValue = function (strFieldId) {
		return this.getFieldValue(strFieldId).toString();
	};
	...
	this.getFields = function () {
		...
		var nSize = arrKeys.length;
		var arrFields = new Array();
		for (var i = 0; i < nSize; i = i + 1) {
