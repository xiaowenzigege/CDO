 ...
 *
 */
public abstract class CDOJSONServlet extends HttpServlet
{
	private Logger logger=Logger.getLogger(CDOJSONServlet.class);
	private static Logger log=Logger.getLogger(CDOJSONServlet.class);
