...
/**
 * Class PostEventGroupDescriptor.
 * 
...
public class PostEventGroupDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostEventGroupDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PostEventGroupDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PostEventGroup.class;
