...
/**
 * Class PostTransactionDescriptor.
 * 
...
public class PostTransactionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostTransactionDescriptor() 
     {
        ...
        //-- _returnCode
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.ReturnCode.class, "_returnCode", "ReturnCode", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PostTransaction target = (PostTransaction) object;
                    target.setReturnCode( (com.cdoframework.cdolib.service.framework.transfilter.schema.ReturnCode) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.cdoframework.cdolib.service.framework.transfilter.schema.ReturnCode();
            }
        };
        desc.setHandler(handler);
        desc.setMultivalued(false);
        ...
        desc.setValidator(fieldValidator);
        //-- _transactionList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.Transaction.class, "_transactionList", "Transaction", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PostTransaction target = (PostTransaction) object;
                    target.addTransaction( (com.cdoframework.cdolib.service.framework.transfilter.schema.Transaction) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PostTransactionDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PostTransaction.class;
