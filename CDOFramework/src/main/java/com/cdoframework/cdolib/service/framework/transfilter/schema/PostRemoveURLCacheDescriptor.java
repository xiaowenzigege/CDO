...
/**
 * Class PostRemoveURLCacheDescriptor.
 * 
...
public class PostRemoveURLCacheDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostRemoveURLCacheDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _removeURLCacheList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.RemoveURLCache.class, "_removeURLCacheList", "RemoveURLCache", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PostRemoveURLCache target = (PostRemoveURLCache) object;
                    target.addRemoveURLCache( (com.cdoframework.cdolib.service.framework.transfilter.schema.RemoveURLCache) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _removeURLCacheList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PostRemoveURLCacheDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PostRemoveURLCache.class;
