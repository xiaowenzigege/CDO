...
public class PreLoadCacheDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PreLoadCacheDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PreLoadCacheDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PreLoadCache.class;
