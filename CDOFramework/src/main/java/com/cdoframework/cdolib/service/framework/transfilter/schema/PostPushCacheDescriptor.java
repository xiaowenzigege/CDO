...
public class PostPushCacheDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostPushCacheDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _pushCacheList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.PushCache.class, "_pushCacheList", "PushCache", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PostPushCache target = (PostPushCache) object;
                    target.addPushCache( (com.cdoframework.cdolib.service.framework.transfilter.schema.PushCache) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _pushCacheList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PostPushCacheDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PostPushCache.class;
