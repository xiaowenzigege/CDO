...
/**
 * Class PostRemoveCacheDescriptor.
 * 
...
public class PostRemoveCacheDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PostRemoveCacheDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _removeCacheList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.RemoveCache.class, "_removeCacheList", "RemoveCache", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PostRemoveCache target = (PostRemoveCache) object;
                    target.addRemoveCache( (com.cdoframework.cdolib.service.framework.transfilter.schema.RemoveCache) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _removeCacheList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PostRemoveCacheDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PostRemoveCache.class;
