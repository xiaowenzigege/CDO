...
/**
 * Class PreTransactionDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PreTransactionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PreTransactionDescriptor() 
     {
        super();
        xmlName = "PreTransaction";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PreTransaction target = (PreTransaction) object;
                if(!target.hasSyn())
                    return null;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PreTransactionDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PreTransaction.class;
