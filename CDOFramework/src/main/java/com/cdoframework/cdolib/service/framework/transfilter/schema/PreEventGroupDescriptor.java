...
/**
 * Class PreEventGroupDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PreEventGroupDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PreEventGroupDescriptor() 
     {
        super();
        xmlName = "PreEventGroup";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PreEventGroup target = (PreEventGroup) object;
                if(!target.hasSyn())
                    return null;
        ...
        desc.setValidator(fieldValidator);
        //-- _forList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.For.class, "_forList", "For", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PreEventGroup target = (PreEventGroup) object;
                    target.addFor( (com.cdoframework.cdolib.service.framework.transfilter.schema.For) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PreEventGroupDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PreEventGroup.class;
