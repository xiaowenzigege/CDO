...
public class PrePushCacheDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PrePushCacheDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PrePushCacheDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.PrePushCache.class;
