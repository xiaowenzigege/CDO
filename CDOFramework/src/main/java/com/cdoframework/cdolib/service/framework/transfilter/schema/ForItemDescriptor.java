...
/**
 * Class ForItemDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ForItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ForItemDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _loadCache
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.schema.LoadCache.class, "_loadCache", "LoadCache", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ForItem target = (ForItem) object;
                    target.setLoadCache( (com.cdoframework.cdolib.service.framework.transfilter.schema.LoadCache) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _loadCache
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.ForItemDescriptor()
    ...
    {
        return com.cdoframework.cdolib.service.framework.transfilter.schema.ForItem.class;
