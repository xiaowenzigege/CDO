...
/**
 * Class PreRemoveCache.
 * 
 * @version $Revision$ $Date$
 */
public class PreRemoveCache implements java.io.Serializable {
    ...
    public PreRemoveCache() 
     {
        super();
        _removeCacheList = new ArrayList();
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PreRemoveCache()
     ...
     */
    public static com.cdoframework.cdolib.service.framework.transfilter.schema.PreRemoveCache unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.service.framework.transfilter.schema.PreRemoveCache) Unmarshaller.unmarshal(com.cdoframework.cdolib.service.framework.transfilter.schema.PreRemoveCache.class, reader);
    } //-- com.cdoframework.cdolib.service.framework.transfilter.schema.PreRemoveCache unmarshal(java.io.Reader) 
