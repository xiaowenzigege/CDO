...
public class TransactionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TransactionDescriptor() {
        ...
        //-- requestKeyList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.service.framework.transfilter.xsd.RequestKey.class, "requestKeyList", "RequestKey", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Transaction target = (Transaction) object;
                    target.addRequestKey( (com.cdoframework.cdolib.service.framework.transfilter.xsd.RequestKey) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoframework.cdolib.service.framework.transfilter.xsd.RequestKey();
            }
        };
        desc.setSchemaType("list");
        desc.setComponentType("com.cdoframework.cdolib.service.framework.transfilter.xsd.RequestKey");
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: requestKeyList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass() {
        return com.cdoframework.cdolib.service.framework.transfilter.xsd.Transaction.class;
    }
