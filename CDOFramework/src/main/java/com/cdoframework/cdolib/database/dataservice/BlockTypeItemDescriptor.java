...
public class BlockTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BlockTypeItemDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.database.dataservice.BlockTypeItemDescriptor()
    ...
    {
        return com.cdoframework.cdolib.database.dataservice.BlockTypeItem.class;
