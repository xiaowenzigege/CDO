...
implements java.io.Serializable
{
    ...
    public Order() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.Order()
    ...
    public static com.cdoframework.cdolib.database.dataservice.OrderType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.OrderType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.Order.class, reader);
