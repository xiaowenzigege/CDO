...
public class DataServiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DataServiceDescriptor() {
        ...
        //-- dataServiceChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.database.xsd.DataServiceChoice.class, "dataServiceChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DataService target = (DataService) object;
                    target.setDataServiceChoice( (com.cdoframework.cdolib.database.xsd.DataServiceChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoframework.cdolib.database.xsd.DataServiceChoice();
            }
        };
        desc.setSchemaType("com.cdoframework.cdolib.database.xsd.DataServiceChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new com.cdoframework.cdolib.database.xsd.descriptors.DataServiceChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: dataServiceChoice
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass() {
        return com.cdoframework.cdolib.database.xsd.DataService.class;
    }
