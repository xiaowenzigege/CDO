 ...
 */
public class ReplaceField extends com.cdoframework.cdolib.database.dataservice.FieldType 
implements java.io.Serializable
{
    ...
    public ReplaceField() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.ReplaceField()
    ...
    public static com.cdoframework.cdolib.database.dataservice.FieldType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.FieldType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.ReplaceField.class, reader);
