...
/**
 * Class BigTableConfigDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BigTableConfigDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BigTableConfigDescriptor() 
     {
        super();
        xmlName = "BigTableConfig";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BigTableConfig target = (BigTableConfig) object;
    ...
    } //-- com.cdoframework.cdolib.database.dataservice.BigTableConfigDescriptor()
    ...
    {
        return com.cdoframework.cdolib.database.dataservice.BigTableConfig.class;
