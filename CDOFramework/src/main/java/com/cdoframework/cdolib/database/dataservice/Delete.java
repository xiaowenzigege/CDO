 ...
 */
public class Delete extends com.cdoframework.cdolib.database.dataservice.SQLBlockType 
implements java.io.Serializable
{
    ...
    public Delete() 
     {
        super();
        setRecordCountId("");
    } //-- com.cdoframework.cdolib.database.dataservice.Delete()
    ...
    public static com.cdoframework.cdolib.database.dataservice.SQLBlockType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.SQLBlockType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.Delete.class, reader);
