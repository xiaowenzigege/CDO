...
public class CriteriaTypeOperatorType implements java.io.Serializable {
    ...
    /**
     * The instance of the EXISTS type
     */
    public static final CriteriaTypeOperatorType VALUE_12 = new CriteriaTypeOperatorType(VALUE_12_TYPE, "EXISTS");
    ...
    /**
     * The instance of the NOTEXISTS type
     */
    public static final CriteriaTypeOperatorType VALUE_13 = new CriteriaTypeOperatorType(VALUE_13_TYPE, "NOTEXISTS");
    ...
    /**
     * The instance of the MATCHALL type
     */
    public static final CriteriaTypeOperatorType VALUE_14 = new CriteriaTypeOperatorType(VALUE_14_TYPE, "MATCHALL");
    ...
    /**
     * The instance of the MATCHRIGHT type
     */
    public static final CriteriaTypeOperatorType VALUE_15 = new CriteriaTypeOperatorType(VALUE_15_TYPE, "MATCHRIGHT");
    ...
    } //-- com.cdoframework.cdolib.database.dataservice.types.CriteriaTypeOperatorType(int, java.lang.String)
    ...
    private static java.util.Hashtable init()
    {
        ...
        members.put("EXISTS", VALUE_12);
        members.put("NOTEXISTS", VALUE_13);
        members.put("MATCHALL", VALUE_14);
        members.put("MATCHRIGHT", VALUE_15);
        return members;
     ...
     */
    public static com.cdoframework.cdolib.database.dataservice.types.CriteriaTypeOperatorType valueOf(java.lang.String string)
    {
    ...
    } //-- com.cdoframework.cdolib.database.dataservice.types.CriteriaTypeOperatorType valueOf(java.lang.String) 
