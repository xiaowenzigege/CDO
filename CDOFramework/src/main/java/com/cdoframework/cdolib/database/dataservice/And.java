...
implements java.io.Serializable
{
    ...
    public And() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.And()
    ...
    public static com.cdoframework.cdolib.database.dataservice.CriteriaType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.CriteriaType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.And.class, reader);
