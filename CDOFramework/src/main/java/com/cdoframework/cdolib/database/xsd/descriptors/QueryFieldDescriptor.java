 ...
 */
public class QueryFieldDescriptor extends com.cdoframework.cdolib.database.xsd.descriptors.CollectionNameTypeDescriptor {
    ...
    public QueryFieldDescriptor() {
        ...
        //-- QField
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.database.xsd.QField.class, "QField", "QField", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    QueryField target = (QueryField) object;
                    target.setQField( (com.cdoframework.cdolib.database.xsd.QField) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("com.cdoframework.cdolib.database.xsd.QField");
        desc.setHandler(handler);
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass() {
        return com.cdoframework.cdolib.database.xsd.QueryField.class;
    }
