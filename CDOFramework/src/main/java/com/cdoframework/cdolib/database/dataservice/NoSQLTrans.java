...
implements java.io.Serializable
{
    ...
    public NoSQLTrans() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.NoSQLTrans()
    ...
    public static com.cdoframework.cdolib.database.dataservice.NoSQLTransType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.NoSQLTransType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.NoSQLTrans.class, reader);
