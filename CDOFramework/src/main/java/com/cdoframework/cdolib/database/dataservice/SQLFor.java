 ...
 */
public class SQLFor extends com.cdoframework.cdolib.database.dataservice.SQLBlockType 
implements java.io.Serializable
{
    ...
    public SQLFor() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.SQLFor()
    ...
    public static com.cdoframework.cdolib.database.dataservice.SQLBlockType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.SQLBlockType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.SQLFor.class, reader);
