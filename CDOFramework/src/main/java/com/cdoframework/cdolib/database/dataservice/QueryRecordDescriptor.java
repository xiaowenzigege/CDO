...
/**
 * Class QueryRecordDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class QueryRecordDescriptor extends com.cdoframework.cdolib.database.dataservice.CollectionNameTypeDescriptor {
    ...
    public QueryRecordDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                QueryRecord target = (QueryRecord) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.database.dataservice.QueryRecordDescriptor()
    ...
    {
        return com.cdoframework.cdolib.database.dataservice.QueryRecord.class;
