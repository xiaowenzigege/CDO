...
public class CreteriasTypeItem implements java.io.Serializable {
     ...
     * Field _creteria
     */
    private com.cdoframework.cdolib.database.dataservice.Creteria _creteria;
    ...
    public CreteriasTypeItem() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.CreteriasTypeItem()
     ...
     */
    public com.cdoframework.cdolib.database.dataservice.Creteria getCreteria()
    {
        return this._creteria;
    } //-- com.cdoframework.cdolib.database.dataservice.Creteria getCreteria() 
     ...
     */
    public void setCreteria(com.cdoframework.cdolib.database.dataservice.Creteria creteria)
    {
        this._creteria = creteria;
        this._choiceValue = creteria;
    } //-- void setCreteria(com.cdoframework.cdolib.database.dataservice.Creteria) 
