...
implements java.io.Serializable
{
    ...
    public Creterias() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.Creterias()
    ...
    public static com.cdoframework.cdolib.database.dataservice.CreteriasType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.CreteriasType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.Creterias.class, reader);
