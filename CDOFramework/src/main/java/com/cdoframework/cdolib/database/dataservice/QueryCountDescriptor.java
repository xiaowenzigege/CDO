...
/**
 * Class QueryCountDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class QueryCountDescriptor extends com.cdoframework.cdolib.database.dataservice.CollectionNameTypeDescriptor {
    ...
    public QueryCountDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                QueryCount target = (QueryCount) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.database.dataservice.QueryCountDescriptor()
    ...
    {
        return com.cdoframework.cdolib.database.dataservice.QueryCount.class;
