...
public class OnErrorDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OnErrorDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- com.cdoframework.cdolib.database.dataservice.OnErrorDescriptor()
    ...
    {
        return com.cdoframework.cdolib.database.dataservice.OnError.class;
