...
implements java.io.Serializable
{
    ...
    public Field() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.Field()
    ...
    public static com.cdoframework.cdolib.database.dataservice.FieldType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.FieldType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.Field.class, reader);
