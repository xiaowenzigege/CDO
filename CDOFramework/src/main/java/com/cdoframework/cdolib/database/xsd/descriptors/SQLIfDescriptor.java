...
public class SQLIfDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SQLIfDescriptor() {
        ...
        //-- operator
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.database.xsd.types.SQLIfOperatorType.class, "operator", "Operator", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLIf target = (SQLIf) object;
                    target.setOperator( (com.cdoframework.cdolib.database.xsd.types.SQLIfOperatorType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(com.cdoframework.cdolib.database.xsd.types.SQLIfOperatorType.class, handler);
        desc.setImmutable(true);
        ...
        desc.setValidator(fieldValidator);
        //-- type
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.database.xsd.types.SQLIfTypeType.class, "type", "Type", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLIf target = (SQLIf) object;
                    target.setType( (com.cdoframework.cdolib.database.xsd.types.SQLIfTypeType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(com.cdoframework.cdolib.database.xsd.types.SQLIfTypeType.class, handler);
        desc.setImmutable(true);
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLIf target = (SQLIf) object;
                    target.setSQLThen( (com.cdoframework.cdolib.database.xsd.SQLThen) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoframework.cdolib.database.xsd.SQLThen();
            }
        };
        ...
        desc.setValidator(fieldValidator);
        //-- SQLElse
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.database.xsd.SQLElse.class, "SQLElse", "SQLElse", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLIf target = (SQLIf) object;
                    target.setSQLElse( (com.cdoframework.cdolib.database.xsd.SQLElse) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoframework.cdolib.database.xsd.SQLElse();
            }
        };
    ...
    public java.lang.Class getJavaClass() {
        return com.cdoframework.cdolib.database.xsd.SQLIf.class;
    }
