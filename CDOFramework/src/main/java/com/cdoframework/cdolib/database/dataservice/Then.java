...
implements java.io.Serializable
{
    ...
    public Then() 
     {
        super();
    } //-- com.cdoframework.cdolib.database.dataservice.Then()
    ...
    public static com.cdoframework.cdolib.database.dataservice.BlockType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.BlockType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.Then.class, reader);
