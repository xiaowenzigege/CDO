...
public class SQLTransDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SQLTransDescriptor() {
        ...
        //-- SQLTransChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoframework.cdolib.database.xsd.SQLTransChoice.class, "SQLTransChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLTrans target = (SQLTrans) object;
                    target.setSQLTransChoice( (com.cdoframework.cdolib.database.xsd.SQLTransChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoframework.cdolib.database.xsd.SQLTransChoice();
            }
        };
        desc.setSchemaType("com.cdoframework.cdolib.database.xsd.SQLTransChoice");
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new com.cdoframework.cdolib.database.xsd.descriptors.SQLTransChoiceDescriptor());
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass() {
        return com.cdoframework.cdolib.database.xsd.SQLTrans.class;
    }
