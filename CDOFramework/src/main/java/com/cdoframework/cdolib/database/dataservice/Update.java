 ...
 */
public class Update extends com.cdoframework.cdolib.database.dataservice.SQLBlockType 
implements java.io.Serializable
{
    ...
    public Update() 
     {
        super();
        setRecordCountId("");
    } //-- com.cdoframework.cdolib.database.dataservice.Update()
    ...
    public static com.cdoframework.cdolib.database.dataservice.SQLBlockType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.cdoframework.cdolib.database.dataservice.SQLBlockType) Unmarshaller.unmarshal(com.cdoframework.cdolib.database.dataservice.Update.class, reader);
