...
3  servicebusResource 与    pluginsConfig.xml 组装成servicebus对象

4  frameworkResource  与  filtersConfig.xml  组装成framework对象

注： 因 servicebusResource 和frameworkResource,CDO.conf由运维人员配置     故需要剥离可进行配置
